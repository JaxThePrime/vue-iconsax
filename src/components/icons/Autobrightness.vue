...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'twotone'">
    ...
    <path
      ...
      stroke-linejoin="round"
    ></path>
    <g opacity=".4" :stroke="color" :stroke-width="strokeWidth">
      <path d="m8.5 15.939 3.5-7.88 3.5 7.88" stroke-linejoin="bevel"></path>
      <path d="M13.75 13.309h-3.5" stroke-linecap="round" stroke-linejoin="round"></path>
    </g>
  </svg>
