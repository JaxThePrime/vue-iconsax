...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'bulk'">
    ...
    <path opacity=".4" d="M8.67 14H4c-1.1 0-2 .9-2 2v6h6.67v-8Z" :fill="color"></path>
    <path d="M13.33 10h-2.67c-1.1 0-2 .9-2 2v10h6.67V12a2 2 0 0 0-2-2Z" :fill="color"></path>
    <path opacity=".4" d="M20 17h-4.67v5H22v-3c0-1.1-.9-2-2-2Z" :fill="color"></path>
    <path
