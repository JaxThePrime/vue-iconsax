...
<div align="center">
  ...
  <p align="center">
    A total of 6000 icons in 6 different designs, all perfectly balanced and based on a 24px grid. 
    <br>
    <br>
    <a href="#"><strong> Explore the site </strong></a>
    ·
    <a href="#">Report Bug</a>
    ·
...
<p dir="auto">Icon-sax in your Vue projects </p> 
<p dir="auto">The features of this package include the following: </p>
<ul dir="auto">
<li> Having a total of 6000 icons in 6 different sizes</li>
<li> Perfectly balance</li>
<li> 24px grid-based </li>
<li>Lightweight, powerful and easy to use <g-emoji class="g-emoji" alias="smile" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f604.png"><img class="emoji" alt="smile" src="https://github.githubassets.com/images/icons/emoji/unicode/1f604.png" width="20" height="20"></g-emoji></li>
</ul>
...
<li>Install Yarn package
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto"><pre>yarn add vue-iconsax</pre><div class="zeroclipboard-container position-absolute right-0 top-0">
...
</li><li>Install NPM package
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto"><pre>npm install vue-iconsax</pre><div class="zeroclipboard-container position-absolute right-0 top-0">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn js-clipboard-copy m-2 p-0 tooltipped-no-delay" data-copy-feedback="Copied!" data-tooltip-direction="w" value="npm install" tabindex="0" role="button">
      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy js-clipboard-copy-icon m-2">
    <path fill-rule="evenodd" d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 010 1.5h-1.5a.25.25 0 00-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 00.25-.25v-1.5a.75.75 0 011.5 0v1.5A1.75 1.75 0 019.25 16h-7.5A1.75 1.75 0 010 14.25v-7.5z"></path><path fill-rule="evenodd" d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0114.25 11h-7.5A1.75 1.75 0 015 9.25v-7.5zm1.75-.25a.25.25 0 00-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 00.25-.25v-7.5a.25.25 0 00-.25-.25h-7.5z"></path>
</svg>
...
<span class="pl-kos">&lt;</span><span class="pl-ent">template</span>&gt;<span>
  <span class="pl-kos">&lt;</span><span class="pl-ent">Wallet</span> <span class="pl-c1">color</span>="<span class="pl-s">"blue"</span> <span class="pl-c1">size</span>="<span class="pl-s">"50"</span> <span class="pl-c1">type</span>="<span class="pl-s">"linear"</span><span class="pl-kos">&gt;</span>
...
<span class="pl-k">import</span> <span class="pl-v">{ Wallet } </span> <span class="pl-k">from</span> <span class="pl-s">'vue-iconsax'</span>
<span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-kos">{</span>
<span class="pl-en">component<span class="pl-kos">:</span></span> <span class="pl-s">{</span>
    <span class="pl-en">wallet, </span>
...
<h1 dir="auto"><a id="user-content-Props" class="anchor" aria-hidden="true" href="#Props"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg></a>Props</h1>
...
<td>24px</td>
<td>size={24} or size="24"</td>
</tr>
<tr>
<td><code>variant</code></td>
<td>
<code>Linear</code> <code>Outline</code> <code>TwoTone</code> <code>Bulk</code> <code>Broken</code> <code>Bold</code>
</td>
...
<h1 dir="auto"><a id="user-content-contact" class="anchor" aria-hidden="true" href="#contact"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg></a>Contact</h1>
<p dir="auto">Emad Moghimi - <a href="emmoghimi@gmail.com">emmoghimi@gmail.com</a></p>
